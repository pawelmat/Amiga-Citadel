...
;		dbf	d0,m_lup				; do NOT slow down the main engine
		...
		moveq.w	#0,sv_updateFrame
		cmpi.b	#UPDATE_TIME,sv_Time+2
		bmi.s	.sv_noActionUpdate0
		moveq.w	#1,sv_updateFrame		; mark frame for anim/enemy/other updates
...
;Tommorow is Gosha's birthday... I love you...
