...
;----------------------------
MAIN_LOOP:	
;		move	sv_Opoznienie,d0
m_lup:		
		VBLANK
;		dbf	d0,m_lup				; do NOT slow down the main engine
		move	#0,sv_fps
		move	#0,sv_updateFrame
		cmpi.b	#UPDATE_TIME,sv_Time+2
		bmi.s	.sv_noActionUpdate0
		move	#1,sv_updateFrame		; mark frame for anim/enemy/other updates
		;subi.b	#UPDATE_TIME,sv_Time+2
		move.b	#0,sv_Time+2
.sv_noActionUpdate0:
...
.sv_NoTel:	
		move	sv_fps,d0		; scale walkspeed based on fps
		addq	#1,d0
		move	d0,sv_fps+2
		cmpi	#5,d0
		bmi.s	.sv_nofpscorrect
		moveq	#5,d0
.sv_nofpscorrect:
		mulu	#55,d0
...
.nl_00:
		addi.b	#1,sv_Time+2	;frame counter used to scale update speed
		addi	#1,sv_fps
.nl_01:
		move	#0,RealCopper+2		;flash screen red
		tst	do_Flash
		beq.s	.nl_2
; --- patch start ---
...
sv_Mou4:
		...
		tst	sv_Vodka
		beq.s	sv_NoVodka
		tst		sv_updateFrame		; only update in update frames
		beq.s	sv_NoVodka
		subi	#1,sv_Vodka
...
cc_h:		cmpi.b	#$b5,d0			;h - fps on/off
		bne.w	cc_m
		eori	#1,sv_fps+4
		bra	cc_NoKey
...
sv_UserMap:	equ	BASEC+$00000+$2a300		;$200 (64*8)

sv_MAP:		equ	BASEC+$00000+$2b600		;$8000
sv_LEVELDATA:	equ	BASEC+$00000+$2b600+$8000
sv_EnemyDATA:	equ	BASEC+$00000+$2b600+$8000+40
sv_SwitchDATA:	equ	BASEC+$00000+$2b600+$8000+4136	;all $9400 (37800)
sv_SAMPLES:	equ	BASEC+$00000+$34e58		;102108 ($18f24)

sv_Bomba:	equ	BASEC+$00000+$4dd34		;$15cc
sv_RotTable:	equ	BASEC+$00000+$4f300		;rot table ($41f2)
sv_ChaosTab:	equ	BASEC+$00000+$534f2		;$6c0;nie rozbijac bloku!
sv_ChaosTac:	equ	BASEC+$00000+$53bb2		;$800
sv_Numbers:	equ	BASEC+$00000+$543b2		;$1ae
sv_Fonts:	equ	BASEC+$00000+$54560		;$300
sv_sinus:	equ	BASEC+$00000+$54860		;$280

mc_Htab:	equ	BASEC+$00000+$54b00		;$1ba0
sv_CompasClr:	equ	BASEC+$00000+$56770		;$6c
sv_CompasSav:	equ	BASEC+$00000+$567e0		;$21c
sv_DATA_AREA:	equ	BASEC+$00000+$56a00		;$600
sv_ConstTab:	equ	BASEC+$00000+$57000		;$46
sv_FloorTab:	equ	BASEC+$00000+$57050		;$8c
sv_DeltaTab:	equ	BASEC+$00000+$57100		;$12c0 (�290 * 4)
sv_ScrOffTab:	equ	BASEC+$00000+$58410		;$100
sv_TextOffsets:	equ	BASEC+$00000+$58520		;$100 (to 128 texts)
;RealCopper:	equ	BASEC+$80000+$58630		;$da0	defined upper!
sv_C1Save:	equ	BASEC+$00000+$593d0		;$21c
sv_C2Save:	equ	BASEC+$00000+$595f0		;$21c

sv_ZeroTab:	equ	BASEC+$00000+$59820		;[192*8]*14 $5400
sv_ScrTabC:	equ	BASEC+$00000+$60a20		;max $6000
...
sv_RomAddr:	dc.l	$f90000			;!!! TO REMOVE USELESS (asman)
...
sv_updateFrame:	dc.w	0			; 0 - no anim/enemy update, 1 - update in this loop
sv_fps:		dc.w	0,0,0			; current fps, previous fps, show fps (0-no, 1-yes)
...
>extern	"Assets/WALLS1A.VIR",BASE+co_Walls,-1
>extern	"Assets/WALLS1B.VIR",BASE+co_Walls+83200,-1
>extern	"Assets/ENEMY1A.VIR",BASE+co_Walls+83200+83200,-1
>extern	"Assets/ENEMY1B.VIR",BASE+co_Walls+83200+83200+52000,-1
>extern	"Assets/LEVEL01B.MAP",sv_MAP,-1
>extern	"Assets/COLS01.DAT",sc_colors,-1

>extern	"Assets/ITEMS01.VIR",BASE+co_Walls+270400
>extern	"Assets/WINDOW1.RAW",screen,-1
>extern	"Assets/TABLES.DAT",sv_bomba,-1
